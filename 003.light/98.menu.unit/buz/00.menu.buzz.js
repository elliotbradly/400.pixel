...
const updateMenu = async (cpy, bal, ste) => {
    ...
    lst = [ActClr.WRITE_COLOR, ActClr.READ_COLOR, ActLgt.UPDATE_LIGHT, ActClr.OPEN_COLOR, ActLgt.READ_LIGHT];
    ...
    switch (src) {
        case ActClr.WRITE_COLOR:
            ...
            bit = await ste.hunt(ActClr.WRITE_COLOR, { idx: 'clr000', dat: { lst: datClr } });
