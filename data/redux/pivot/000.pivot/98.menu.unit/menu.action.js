...
var InitMenu = /** @class */ (function () {
    function InitMenu(bale) {
        this.bale = bale;
...
var CloseMenu = /** @class */ (function () {
    function CloseMenu(bale) {
        this.bale = bale;
...
var ShadeMenu = /** @class */ (function () {
    function ShadeMenu(bale) {
        this.bale = bale;
...
var VisageMenu = /** @class */ (function () {
    function VisageMenu(bale) {
        this.bale = bale;
...
var ContainerMenu = /** @class */ (function () {
    function ContainerMenu(bale) {
        this.bale = bale;
